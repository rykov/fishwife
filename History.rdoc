=== 1.7.0 (2015-2-12)
* Added a complete implementation of a input stream rewind for
  request bodies, per Rack requirements. This uses an in memory
  StringIO up to a configurable threshold size before writing to a
