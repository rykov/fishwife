...
{Jetty}[http://www.eclipse.org/jetty/] 9. \Fishife deploys
...
from which it was originally forked, \Fishife offers the following
unique features:
...
* Depends on the {rjack-jetty}[http://rjack.gravitext.com/jetty] gem
  ...
  independent of the \Fishife release.

* \Fishife may itself be embedded in your own custom server/launcher
...
* Logging is unified across Jetty, \Fishife, and your application via
...
To use \Fishife with your \Rack app and config.ru:
...
* Fishife::HttpServer::new supported options
* example/config.ru
