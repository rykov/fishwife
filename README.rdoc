...
be loaded. The mizuno script will load
...
starting Mizuno through some other means than the mizuno script, you
will need to load an output provider (see linked docs.)

== License

Mizuno is licensed under the Apache Public License, version 2.0; see
the LICENSE file for details, and was developed on behalf of [Mad
Wombat Software](http://www.madwombat.com)
